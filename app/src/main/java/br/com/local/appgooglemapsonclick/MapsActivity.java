...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Parque do Carmo and move the camera
        LatLng pqDoCarmo = new LatLng(-23.571749, -46.4843544);
        //-23.702723,-46.6898242

        //Marcadores
        mMap.addMarker(new MarkerOptions()
                .position(pqDoCarmo)
                .title("Parque do carmo, Jardim Nossa Sra. do Carmo")
                /*.icon(BitmapDescriptorFactory.defaultMarker(
                        //Definindo cores para os icones de posicionamento
                        BitmapDescriptorFactory.HUE_VIOLET
                ))*/
                //Icone costumizado
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.florist_24))

        );
        //Posicionamento da câmera
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(pqDoCarmo, 15));
